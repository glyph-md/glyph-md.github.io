...
export const ui = {
  en: {
    ...
    "cli.heading": "Publish straight from your terminal",
    "cli.subheading":
      "The same renderer as the app, without a window. Turn a note into a document, a folder into a website, and drop either into a docs pipeline.",
    "cli.export.title": "Export a document",
    "cli.site.title": "Export a website",
    "cli.serve.title": "Preview while you write",
    "cli.docker.title": "Docker",
    "cli.formats":
      "--format takes pdf, docx, epub, html, and site. Full reference in the",
    "cli.reference": "README",
  ...
  fa: {
    ...
    "cli.heading": "مستقیم از ترمینال منتشر کنید",
    "cli.subheading":
      "همان موتور رندر برنامه، بدون پنجره. یک یادداشت را به سند، یک پوشه را به وب‌سایت تبدیل کنید و هر دو را در خط تولید مستندات بگذارید.",
    "cli.export.title": "خروجی گرفتن از سند",
    "cli.site.title": "خروجی گرفتن وب‌سایت",
    "cli.serve.title": "پیش‌نمایش هنگام نوشتن",
    "cli.docker.title": "داکر",
    "cli.formats":
      "گزینهٔ --format مقدارهای pdf، docx، epub، html و site را می‌پذیرد. مرجع کامل در",
    "cli.reference": "README",
  ...
  es: {
    ...
    "cli.heading": "Publica directamente desde la terminal",
    "cli.subheading":
      "El mismo renderizador de la app, sin ventana. Convierte una nota en un documento, una carpeta en un sitio web, y lleva cualquiera de los dos a tu flujo de documentación.",
    "cli.export.title": "Exportar un documento",
    "cli.site.title": "Exportar un sitio web",
    "cli.serve.title": "Previsualiza mientras escribes",
    "cli.docker.title": "Docker",
    "cli.formats":
      "--format acepta pdf, docx, epub, html y site. Referencia completa en el",
    "cli.reference": "README",
  ...
  zh: {
    ...
    "cli.heading": "直接从终端发布",
    "cli.subheading":
      "与应用相同的渲染引擎，只是没有窗口。把一篇笔记变成文档，把一个文件夹变成网站，两者都能接入文档流水线。",
    "cli.export.title": "导出文档",
    "cli.site.title": "导出网站",
    "cli.serve.title": "边写边预览",
    "cli.docker.title": "Docker",
    "cli.formats": "--format 接受 pdf、docx、epub、html 和 site。完整说明见",
    "cli.reference": "README",
  ...
  de: {
    ...
    "cli.heading": "Direkt aus dem Terminal veröffentlichen",
    "cli.subheading":
      "Dieselbe Rendering-Engine wie in der App, nur ohne Fenster. Mach aus einer Notiz ein Dokument, aus einem Ordner eine Website, und häng beides in deine Docs-Pipeline.",
    "cli.export.title": "Dokument exportieren",
    "cli.site.title": "Website exportieren",
    "cli.serve.title": "Vorschau beim Schreiben",
    "cli.docker.title": "Docker",
    "cli.formats":
      "--format nimmt pdf, docx, epub, html und site. Vollständige Referenz in der",
    "cli.reference": "README",
