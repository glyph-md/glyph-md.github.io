...
export const ui = {
  ...
  fa: {
    ...
    "meta.description":
      "گلیف یک نمایشگر و ویرایشگر سریع و چندسکویی مارک‌داون با ظاهر بومی هر سیستم‌عامل است. رندر گیت‌هاب‌فلیور، ویرایشگر زنده، بوم بی‌نهایت، ریاضی، نمودار و خروجی PDF.",
    "nav.features": "ویژگی‌ها",
    "nav.download": "دانلود",
    "nav.github": "گیت‌هاب",
    "nav.skip": "پرش به محتوا",
    "hero.badge": "رایگان و متن‌باز",
    "hero.title": "مارک‌داونی که بومی به نظر می‌رسد.",
    "hero.subtitle":
      "نمایشگر و ویرایشگر سریع و چندسکویی مارک‌داون با ظاهر بومی هر سیستم‌عامل. مارک‌داون گیت‌هاب را رندر کنید، زنده ویرایش کنید، روی بوم بی‌نهایت بکشید و به PDF خروجی بگیرید — همه آفلاین، همه از آنِ شما.",
    "hero.cta.download": "دانلود گلیف",
    "hero.cta.github": "ستاره در گیت‌هاب",
    "hero.note": "رایگان، متن‌باز و آفلاین‌محور. مک‌اواس، ویندوز و لینوکس.",
    "features.heading": "هر آنچه یک برنامهٔ مارک‌داون باید باشد",
    "features.subheading":
      "ساخته‌شده با Tauri و React برای حجمی کوچک و حسی بومی روی هر سکو.",
    "features.render.title": "رندر وفادار",
    "features.render.desc":
      "مارک‌داون گیت‌هاب‌فلیور — جدول‌ها، فهرست کارها، پانویس‌ها، هشدارها و لنگر سرفصل‌ها. ریاضی با KaTeX، نمودار Mermaid و برجسته‌سازی نحو در شش پوسته.",
    "features.editor.title": "ویرایشگر زنده",
    "features.editor.desc":
      "ویرایشگر دوپنجره‌ای با پیش‌نمایش زنده، نشانه‌های مارک‌داون سبک‌دار، جستجو در سند و بازگردانی/ازنوسازی برای ویرایش‌های درون‌برنامه‌ای.",
    "features.canvas.title": "بوم بی‌نهایت",
    "features.canvas.desc":
      "پرونده‌های JSON Canvas (.canvas) را به‌صورت بومی پن‌وزوم باز کنید. کارت‌ها مارک‌داون، تصویر و پیوند را رندر می‌کنند و با فلش‌های برچسب‌دار به هم وصل می‌شوند — سازگار با اوبسیدین.",
    ...
    "features.export.title": "خروجی به‌همه‌جا",
    "features.export.desc":
      "چاپ یا خروجی به PDF، HTML، DOCX و EPUB — شامل ریاضی و نمودارهای برداری. اسناد شما دقیقاً همان‌طور که باید، از گلیف خارج می‌شوند.",
    "features.themes.title": "پوسته‌بندی بومی",
    "features.themes.desc":
      "ظاهر سازگار با سکو که حالت روشن و تاریک را رعایت می‌کند، با شش پوستهٔ کد و تایپوگرافی‌ای که روی مک، ویندوز و لینوکس خانگی به نظر می‌رسد.",
    "download.heading": "نصب گلیف",
    "download.subheading":
      "سکوی خود را انتخاب کنید. هر نسخه امضا شده و از خط لولهٔ انتشار منتشر می‌شود.",
    "download.copy": "کپی",
    "download.copied": "کپی شد!",
    "download.manual": "یا یک باینری از",
    "download.releases": "صفحهٔ انتشارها",
    "footer.tagline": "مارک‌داونی که بومی به نظر می‌رسد.",
